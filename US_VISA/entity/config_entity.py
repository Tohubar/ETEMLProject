...
class DataValidationConfig:
    data_validation_dir = os.path.join(training_pipline_config.artifact_dir, DATA_VALIDATION_DIR_NAME)
    data_drift_report_file_path = os.path.join(data_validation_dir, DATA_VALIDATION_DRIFT_REPORT_DIR, DATA_VALIDATION_DRIFT_REPORT_FILE_NAME)
